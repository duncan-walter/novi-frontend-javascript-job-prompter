...
const userJobInput = prompt("Je koos marketing. Over welke functie wil je meer weten? Voer eem getal tussen 0 en 3 in." +
...
switch (userJobInput) {
    ...
    case "2":
    case "3":
        console.log(`Je koos ${departments.marketing.jobs[userJobInput].title}. Een uitdagende rol! ${departments.marketing.jobs[userJobInput].description}.`);
        break;
    default:
        console.error("Ongeldige keuze.");
        break;
